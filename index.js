...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently, ${unfundedGamesCount} game${unfundedGamesCount == 1 ? " remains" : "s remain"} unfunded. We need your help to fund these amazing games!`;


//create new paragraph element 
const paragraph = document.createElement("p");

//set paragraph's text content to the display string
